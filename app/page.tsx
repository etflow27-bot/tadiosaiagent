...
// Adjust import paths for Next.js app/ directory structure
...
export default function Home() {
  ...
  return (
    <div className="bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-50 font-sans selection:bg-brand-500/30 selection:text-brand-600 dark:selection:text-brand-300 transition-colors duration-300 overflow-x-hidden">
        ...
        <section className="relative pt-28 pb-12 lg:pt-48 lg:pb-32 overflow-hidden">
          ...
          <div className="container mx-auto px-4 md:px-6 relative z-10">
            <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-20">
              ...
              {/* Right Content - Integration Hub Visual */}
                ...
                <div className="w-full lg:w-1/2">
                   <Reveal>
                      ...
                      <button 
                        ...
                        className="inline-flex items-center gap-2 px-6 py-3 bg-slate-900 dark:bg-white text-white dark:text-slate-900 font-bold rounded-xl hover:bg-slate-800 dark:hover:bg-slate-200 transition-all shadow-lg hover:translate-y-[-2px]"
                      >
           ...
           <div className="container mx-auto px-6 relative z-10" ref={processSectionRef}>
              ...
              <div className="relative">
                 <div className="hidden md:block absolute top-[24px] left-0 w-full h-1 bg-slate-200 dark:bg-slate-800 z-0">
                    <div className="h-full bg-brand-500" style={{ width: `${processProgress * 100}%` }}></div>
                 </div>
                 <div className="md:hidden absolute left-[24px] top-0 bottom-0 w-1 bg-slate-200 dark:bg-slate-800 z-0">
                    <div className="w-full bg-brand-500" style={{ height: `${processProgress * 100}%` }}></div>
                 </div>
                    ...
                    <div className="w-full lg:w-5/12 space-y-8">
                       <div>
                         ...
                         <p className="text-lg text-slate-400 leading-relaxed mb-8">
                           We help businesses like yours automate workflows and reclaim time. Schedule a free consultation or send us a message.
                         </p>
                       </div>
                       ...
                       <div className="bg-slate-900/50 p-6 rounded-2xl border border-slate-800 backdrop-blur-sm mt-8">
                          <div className="flex items-center gap-4 mb-4">
                             <div className="w-12 h-12 bg-brand-600 rounded-full flex items-center justify-center text-white shadow-lg shadow-brand-500/20 animate-pulse-slow">
                                <Calendar size={24} />
                             </div>
                             <div>
                                <h3 className="font-bold text-white">Free Consultation</h3>
                                <p className="text-sm text-slate-400">No sales pressure. Just a chat.</p>
                             </div>
                          </div>
                          <a 
                            ...
                            className="block w-full py-3 text-center bg-white text-slate-900 hover:bg-slate-100 font-bold rounded-xl transition-all shadow-lg"
                          >
